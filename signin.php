...
<body style="background: url(image/Login.jpg); background-size: cover;" class="trans">
        ...
        <center>
            <div style="padding-top: 175px;">
                <a href="index.php" onclick="window.close();">
                    <img src="image/E-Tiket.png" class="img-responsive" style="width: 100px; height: 100px;">
                </a>
