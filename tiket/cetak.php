...
<head>
    <title>E-Tiket | Penyedia Tiket terlucu</title>
            ...
            <div class="col s7">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col s6">
                                <img src="../image/E-Tiket.png" class="center" style="width: 75px; height: 75px; margin-left: 100px;">
                            </div>
                            <div class="col s6">
                                <form>
                                    <div class="input-field">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col s6">
                                <img src="../image/E-Tiket.png" class="center" style="width: 75px; height: 75px; margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
